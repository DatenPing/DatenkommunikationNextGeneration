...
public class BenchmarkingClientGuiFx2 extends Application
    ...
    private Pane createInputPane() {
        ...
        textFieldNumberOfClientThreads = createEditableTextfield(inputPane, 3, 3, "10");

        numberOfMessagesPerClients = createLabel("Anzahl Nachrichten je Client");
        inputPane.add(numberOfMessagesPerClients, 1, 5);
        textFieldNumberOfMessagesPerClients = createEditableTextfield(inputPane, 3, 5, "20");
        ...
        textFieldMessageLength = createEditableTextfield(inputPane, 7, 3, "20");
